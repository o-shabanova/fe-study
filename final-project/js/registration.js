...
function readUserPaymentMedium() {
    ...
    if (document.getElementById("payment1").checked) {
        payment.push({
            "img": "payment1.png",
            "label": document.getElementById("payment1-value").innerHTML
        })
    }
    if (document.getElementById("payment2").checked) {
        payment.push({
            "img": "payment2.png",
            "label": document.getElementById("payment2-value").innerHTML
        });
    }
    // console.log(payment);
    return payment;
...
function readUserPlatform() {
    ...
    if (document.getElementById("platform1").checked) {
        platform.push({
            "img": "platform1.png",
            "label": document.getElementById("platform1-value").innerHTML
        })
    }
    if (document.getElementById("platform2").checked) {
        platform.push({
            "img": "platform2.png",
            "label": (document.getElementById("platform2-value").innerHTML)
        })
    }
